...
3. `cd app; flutter pub get; flutter analyze; flutter test` — expect **107 passing tests**, analyzer clean.
...
│   └── test/                      # 107 offline tests (domain, repository, provider, widget_flow,
...
flutter test           # 107 tests: domain, repository, provider, widget_flow, error_mapper, accessibility
