...
3. `cd app; flutter pub get; flutter analyze; flutter test` — expect **103 passing tests**, analyzer clean.
...
│   └── test/                      # 103 offline tests (domain, repository, provider, widget_flow,
...
flutter test           # 103 tests: domain, repository, provider, widget_flow, error_mapper, accessibility
