...
3. `cd app; flutter pub get; flutter analyze; flutter test` — expect **83 passing tests**, analyzer clean.
...
│   └── test/                      # 83 offline tests (domain, repository, provider, widget_flow,
...
flutter test           # 83 tests: domain, repository, provider, widget_flow, error_mapper, accessibility
