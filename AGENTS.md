...
3. `cd app; flutter pub get; flutter analyze; flutter test` — expect **98 passing tests**, analyzer clean.
...
│   └── test/                      # 98 offline tests (domain, repository, provider, widget_flow,
...
flutter test           # 98 tests: domain, repository, provider, widget_flow, error_mapper, accessibility
